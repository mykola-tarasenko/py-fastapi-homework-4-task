...
async def register_user(
    ...
    Args:
        ...
        email_sender (EmailSenderInterface): Email sending tool.
    ...
    try:
        ...
        await email_sender.send_activation_email(str(user_data.email), activation_link)
...
async def activate_account(
    ...
    await email_sender.send_activation_complete_email(str(user.email), login_link)
...
async def request_password_reset_token(
    ...
    reset_password_complete_link = "http://127.0.0.1/api/v1/accounts/reset-password/complete/"
    await email_sender.send_password_reset_email(str(user.email), reset_password_complete_link)
...
async def reset_password(
    ...
    login_link = "http://127.0.0.1/api/v1/accounts/login/"
    await email_sender.send_password_reset_complete_email(str(user.email), login_link)
